...
?>
	<tr  class="lst<?php echo $col; ?>">
		<td align="center"><input type="checkbox" class="inc" id="del_<?php echo $val["name"]; ?>" name="d[]" value="<?php echo $val["name"]; ?>" /></td>
...
<table cellspacing="0" cellpadding="4">
	...
	<tr>
		<td><input type="submit" class="inb" name="submit" value="<?php __("Create my main database"); ?>" /></td>
	</tr>
</table>
</form>
<?php } ?>
