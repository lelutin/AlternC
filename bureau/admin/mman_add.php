<?php
/*
 $Id: mman_add.php 2 2003-06-13 20:30:40Z root $
 ----------------------------------------------------------------------
...
<table>
	<tr>
		<th><label for="login"><?php __("Email address"); ?></label></th>
		<td>
	...
	<tr>
	<th><label for="owner"><?php __("Owner"); ?> *</label></th>
		<td>
			Email : <input type="text" class="int" id="owner" name="owner" value="<?php echo $owner; ?>" size="20" maxlength="64" />
		</td>
		</tr>
	<tr>
		<th><label for="pass"><?php __("Initial list password"); ?> </label></th>
		<td>
